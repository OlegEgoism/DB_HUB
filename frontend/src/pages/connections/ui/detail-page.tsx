                        ...
                        {users.map((user) => (
                          <div key={user.oid} className={clsx(styles.userItem)}>
                            ...
                            <div className={clsx(styles.userItemContent)}>
                              {user.description && (
                                <div className={clsx(styles.userItemRow)}>
                                  <div className={clsx(styles.userItemLabel)}>Описание:</div>
                                  <div className={clsx(styles.userItemValue)}>{user.description}</div>
                                </div>
                              )}
                              {user.email && (
                                <div className={clsx(styles.userItemRow)}>
                                  <div className={clsx(styles.userItemLabel)}>Email:</div>
                                  <div className={clsx(styles.userItemValue)}>{user.email}</div>
                                </div>
                              )}
                            </div>
                          </div>
