    ...
    return (
        <div className={clsx(styles.modal__overlay)}>
            <div className={clsx(styles.modal__content)}>
                <button className={clsx(styles.modal__closeButton)} onClick={handleClose} disabled={loading} aria-label="Закрыть окно создания">
                ...
                {success ? (
                    ...
                    <form onSubmit={handleSubmit} className={clsx(styles.modal__form)} autoComplete="off">
                        ...
                        <div className={clsx(styles.modal__formGroup)}>
                            <label htmlFor="name" className={clsx(styles.modal__label)}>Название подключения *</label>
                            <input
                                type="text"
                                id="name"
                                name="name"
                        ...
                        <div className={clsx(styles.modal__formGroup)}>
                            <div className={clsx(styles.modal__dualRow)}>
                                <div className={clsx(styles.modal__dualColumn)}>
                                    <label htmlFor="database_type" className={clsx(styles.modal__label)}>Тип базы данных *</label>
                                    <select id="database_type" name="database_type" value={formData.database_type} onChange={handleChange} className={clsx(styles.modal__select)} disabled={loading}>
                                        <option value="postgresql">PostgreSQL</option>
                                        <option value="greenplum">Greenplum</option>
                                    </select>
                                </div>
                                <div className={clsx(styles.modal__dualColumn)}>
                                    <label htmlFor="environment" className={clsx(styles.modal__label)}>Окружение *</label>
                                    <select id="environment" name="environment" value={formData.environment} onChange={handleChange} className={clsx(styles.modal__select)} disabled={loading}>
                        ...
                        <div className={clsx(styles.modal__formGroup)}>
                            <label htmlFor="database_name" className={clsx(styles.modal__label)}>Имя БД *</label>
                            <input
                                type="text"
                                id="database_name"
                                name="database_name"
                        ...
                        <div className={clsx(styles.modal__formGroup)}>
                            <div className={clsx(styles.modal__dualRow)}>
                                <div className={clsx(styles.modal__dualColumn)}>
                                    <label htmlFor="username" className={clsx(styles.modal__label)}>Пользователь *</label>
                                    <input
                                        type="text"
                                        id="username"
                                        name="username"
                        ...
                        <div className={clsx(styles.modal__formGroup)}>
                            <label htmlFor="host" className={clsx(styles.modal__label)}>Хост *</label>
                            <input
                                type="text"
                                id="host"
                                name="host"
                        ...
                        <div className={clsx(styles.modal__formGroup)}>
                            <label htmlFor="port" className={clsx(styles.modal__label)}>Порт *</label>
                            <input
                                type="number"
                                id="port"
                                name="port"
