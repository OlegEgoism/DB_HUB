...
const EXACT_RU_TO_EN: Record<string, string> = {
  ...
  'Порт:': 'Port:',
  'Пользователь:': 'User:',
  'Размер базы данных:': 'Database size:',
  'Версия СУБД:': 'DBMS version:',
  'Кодировка:': 'Encoding:',
  'Авто очистка:': 'Autovacuum:',
  'Логирование:': 'Logging:',
  'Коллация:': 'Collation:',
  'Буфер:': 'Buffer:',
  'Рабочая память:': 'Work memory:',
  'Временная зона:': 'Time zone:',
  'Время работы:': 'Uptime:',
  'Начало работы:': 'Started at:',
  'Дата создания подключения:': 'Connection created at:',
  'Структура базы': 'Database structure',
  'Количество таблиц:': 'Tables count:',
  'Размер таблиц:': 'Tables size:',
  'Количество временных таблиц:': 'Temporary tables count:',
  'Размер временных таблиц:': 'Temporary tables size:',
  'Количество системных таблиц:': 'System tables count:',
  'Размер системных таблиц:': 'System tables size:',
  'Количество индексов:': 'Indexes count:',
  'Размер индексов:': 'Indexes size:',
  'Количество представлений:': 'Views count:',
  'Материализованных представлений:': 'Materialized views:',
  'Хранимых процедур:': 'Stored procedures:',
  'Триггеров:': 'Triggers:',
  'Пользователи и группы': 'Users and groups',
  'Всего пользователей:': 'Total users:',
  'Всего суперпользователей:': 'Total superusers:',
  'Активных пользователей:': 'Active users:',
  'Количество групп:': 'Groups count:',
  'Количество системных групп:': 'System groups count:',
  'Максимальное кол-во подключений:': 'Max connections:',
  'Текущих подключений:': 'Current connections:',
  'Расширения': 'Extensions',
  'Кластеризация и репликация': 'Clustering and replication',
  'Статус репликации:': 'Replication status:',
  'Не поддерживается': 'Not supported',
  'Задержка репликации:': 'Replication lag:',
  'Скачать настройки': 'Download settings',
