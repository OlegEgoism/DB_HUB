...
const WelcomeSection = () => (
  <section className="welcome-section">
    ...
    {/* ... остальные карточки фич — можно оставить как в HTML */}
    <div className="cta-buttons">
      <Link to="/register" className="btn-outline btn-large"><i className="fas fa-user-plus"></i> Регистрация</Link>
      <Link to="/login" className="btn-outline btn-large"><i className="fas fa-sign-in-alt"></i> Войти</Link>
    </div>
  </section>
);
