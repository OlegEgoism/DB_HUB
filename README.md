...
Веб-приложение: управление подключениями к **PostgreSQL / Greenplum**, просмотр объектов БД, метрики, работа с пользователями и группами на сервере БД, выполнение запросов. Метаданные приложения — **SQLite**.
