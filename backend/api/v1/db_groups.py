...
async def list_groups(
    ...
    search: str | None = Query(None, description="Поиск по названию/описанию группы"),
):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Ошибка при получении списка групп: {str(e)}") from e
...
async def get_group(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Ошибка при получении группы: {str(e)}") from e
...
async def update_group(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Ошибка при обновлении группы: {str(e)}") from e
...
async def create_group(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Ошибка при создании группы: {str(e)}") from e
...
async def delete_group(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Ошибка при удалении группы: {str(e)}") from e
