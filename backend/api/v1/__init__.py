...
from backend.api.v1 import app_auth, app_content, app_users, db_connections, db_functions, db_groups, db_indexes, db_metrics, db_procedures, db_query, db_schemas, db_tables, db_users, db_views

api_v1_router = APIRouter(prefix="/api/v1")
api_v1_router.include_router(app_content.router)
