    ...
    async def get_schemas_with_tables(self, connection_id: int, page: int = 1, size: int = 20, search: Optional[str] = None, ) -> Dict[str, Any]:
        ...
        for s in all_schemas:
            ...
            if search_term is None:
                ...
                if search_term in schema_name.lower() or search_term in schema_desc:
                    match = True
                else:
                    tables_query = """
                        SELECT
        ...
        for s in paginated_schemas:
            ...
            for tr in table_rows:
                ...
                tables.append({"table_name": tr["table_name"], "owner": tr["owner"], "description": tr["description"], "row_count": row_count, "size_bytes": size_bytes, "size_pretty": size_pretty, })
